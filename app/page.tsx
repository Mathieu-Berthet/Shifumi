    ...
    <div className="flex flex-col items-center justify-items-center pt-8 pb-20 gap-16 font-[family-name:var(--font-geist-sans)]">
      ...
      {/* <div className="flex flex-raw">
        ...
        <nav className="flex flex-row w-full justify-center mt-2">
          <Link href='./tournament' className="flex border-solid border-black border w-1/3 justify-center">Autre version de l'IA 1</Link>
          <Link href='./tournament' className="flex border-solid border-black border w-1/3 justify-center">Autre version de l'IA 2</Link>
          <Link href='./tournament' className="flex border-solid border-black border w-1/3 justify-center">Autre version de l'IA 3</Link>
        </nav>
      </header>
      ...
      <main className="flex flex-col gap-8 items-center">
        <div className="flex flex-row">
          <div className="flex flex-col mr-64">
            <h2 className="text-2xl font-medium">Jouez à Pierre-Papier-Ciseau </h2>
